#!/usr/bin/env python3
"""
RTC Rennen Import Script - 2022 Format Version
Für Seasons 2022 und älter (anderes CSV-Format)

Unterschiede zu 2023+ Format:
- RaceTime in Spalte 8 (statt 9)
- Penalty in Spalte 7 (statt 8)
- Punkte in Spalte 10 (statt 11)

Verwendung:
    python3 rtc_import_2022.py data/rennen5.csv
...
Environment-Variablen (erforderlich):
    ...
    SEASON_ID       - Saison ID (z.B. 8 für 2022.2)
"""
...
TRACK_NAME_MAP = {
    ...
    'Deep Forrest Raceway': ('Deep Forest Raceway', 'Full Course'),
    ...
    def parse_csv(self) -> Tuple[str, datetime, str, str, List[dict]]:
        ...
        for row in rows[header_idx + 1:]:
            ...
            result = {
                ...
                'penalty_str': row[8].strip(),  # SPALTE 7!
